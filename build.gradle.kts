...
plugins {
    ...
    id("org.jetbrains.intellij.platform") version "2.4.0"     // See https://github.com/JetBrains/intellij-platform-gradle-plugin/releases    // See https://github.com/JetBrains/intellij-platform-gradle-plugin/releases
